...
export async function saveQC() {
  ...
  const payload = {
    ...
    operatorName: document.getElementById("qc-operator")?.value || "",
    operatorContact: document.getElementById("qc-operator-contact")?.value || "",
    repairedBy: document.getElementById("qc-repaired-by")?.value || "",
